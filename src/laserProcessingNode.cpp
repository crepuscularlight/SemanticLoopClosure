...
void laser_processing(){
    while(1){
        if(!pointCloudBuf.empty()){
            ...
            pcl::PointCloud<pcl::PointXYZL>::Ptr pointcloud_surf(new pcl::PointCloud<pcl::PointXYZL>());
            ...
            pcl::PointCloud<pcl::PointXYZL>::Ptr pointcloud_filtered(new pcl::PointCloud<pcl::PointXYZL>());  
