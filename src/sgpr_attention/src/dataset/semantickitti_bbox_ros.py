...
from sgpr_attention.src.dataset.utils import load_paires, process_pair_bbox,load_ros_pair
...
class SemanticKittiBboxROS(data.Dataset):
    def __init__(self, cfg, mode="train"):
        ...
        self.graphs = []
        self.mode = mode
        self.test_sequences=self.cfg.test_sequences[0]
    ...
    def set_frames(self,check_frame_id,current_frame_id):
        self.graphs=[]
        graphs=load_ros_pair(self.graph_pairs_dir,self.test_sequences,check_frame_id,current_frame_id)
