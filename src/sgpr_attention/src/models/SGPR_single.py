...
from sgpr_attention.src.models.components.layers_batch import DiffDiffTensorNetworkModule,DiffTensorNetworkModule,AttentionModule, TensorNetworkModule,MultiheadAttentionModule
...
class SGPR_Single(nn.Module):
    ...
    def setup_layers(self):
        ...
        self.dgcnn_conv_end = nn.Sequential(nn.Conv1d(self.cfg.filters_dim[-1] ,  # 3
